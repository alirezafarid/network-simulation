...
"prodcuer tag1" 1.0 0 -7500403 true "" "carefully[\nif (ticks > 0 and total-number-of-turns mod  number-of-agents = 0) [\nplot mean [score] of turtles with [not document? and  breed = document-popularity-producer-profiles and tags = [1]] ]\n\n]\n[\nplot 0\n]"
"producer tag0" 1.0 0 -955883 true "" "carefully[\nif (ticks > 0 and total-number-of-turns mod  number-of-agents = 0) [\nplot mean [score] of turtles with [not document? and  breed = document-popularity-producer-profiles and tags = [0]] ]\n\n]\n[\nplot 0\n]"
