...
"profiles-1" 1.0 0 -2674135 true "" "carefully [\nifelse (ticks > 0) [plot sum [score] of turtles with [not document? and active? and breed = profiles1]]\n[plot 0]]\n[plot 0]"
"profiles-2" 1.0 0 -11221820 true "" "carefully [\nifelse (ticks > 0) [plot sum [score] of turtles with [not document? and active? and breed = profiles2]]\n[plot 0]]\n[plot 0]"
...
"" ""
PENS
"Complete-random" 1.0 0 -1184463 true "" "carefully[\nif (ticks > 0) [\n plot mean [score] of turtles with [not document? and breed = complete-random-profiles]]\n][\nplot 0\n]"
...
"" ""
PENS
"peer-similarity" 1.0 0 -14439633 true "" "carefully[\nif (ticks > 0) [plot mean [score] of turtles with [not document? and active? and breed = peer-similarity-profiles]]\n]\n[\nplot 0\n]"
...
"" ""
PENS
"Peer-similarity" 1.0 0 -14439633 true "" "carefully [\nifelse (ticks > 0) [plot mean [score] of turtles with [not document? and active? and breed = peer-similarity-profiles]]\n[plot 0]]\n[plot 0]"
"Random selection" 1.0 0 -4079321 true "" "carefully [\nifelse (ticks > 0) [plot mean [score] of turtles with [not document? and active? and breed = complete-random-profiles]]\n[plot 0]]\n[plot 0]"
