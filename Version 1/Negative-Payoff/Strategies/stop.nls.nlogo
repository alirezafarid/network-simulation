...
__includes [
  ...
  "Negative-Payoff/strategies/stop.nls"
...
"" ""
PENS
"Complete-random" 1.0 0 -1184463 true "" "let turn 1\ncarefully [\nifelse (ticks > 0) [plot mean [ item 1 turn-payoff-list] of turtles with [not document? and turns = turn and breed = complete-random-profiles]]\n[plot 0]]\n[plot 0]"
